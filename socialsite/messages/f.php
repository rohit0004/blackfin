...
$fmsg = filter_var(htmlspecialchars($_GET['id']),FILTER_SANITIZE_STRING);	
$gid = filter_var(htmlspecialchars($_GET['g']),FILTER_SANITIZE_STRING);		
$cid = filter_var(htmlspecialchars($_GET['c']),FILTER_SANITIZE_STRING);		
?>
<html>
<head>
 ...
 <div class="navbar-fixed">
    <nav>
      <div class="nav-wrapper">
	   <i class=" material-icons" style="float:left;margin:auto 8px;">arrow_back</i>
...
$('#m_contacts').on("click",".fmsg",function(){
var userid=	$(this).attr('data-muid');
var fmsg="<?php echo $fmsg; ?>";
var cid="<?php echo $cid; ?>";
var gid="<?php echo $gid; ?>";
var requ = "chatforward";
var path = "<?php echo $check_path; ?>";
$.ajax({
    type:'POST',
    url:"<?php echo $check_path; ?>includes/m_forward_request.php",
    data:{'req':requ,'path':path,'userid':userid,'fmsg':fmsg,'gid':gid,'cid':cid},
    success:function(data){
		alert(data);
	 // $("#m_contacts,.userid").prop('disabled', true);
	 // alert(userid);
    alert("your message forward");
    }
});
});
$('#m_contacts_search').on("click",".fmsg",function(){
var userid=	$(this).attr('data-muid');
var fmsg="<?php echo $fmsg; ?>";
var cid="<?php echo $cid; ?>";
var gid="<?php echo $gid; ?>";
...
$('#m_channels_search').on("click",".fmsg",function(){
var channelid=	$(this).attr('data-muid');
var fmsg="<?php echo $fmsg; ?>";
var cid="<?php echo $cid; ?>";
var gid="<?php echo $gid; ?>";
var requ = "channelForward";
var path = "<?php echo $check_path; ?>";
$.ajax({
    type:'POST',
    url:"<?php echo $check_path; ?>includes/m_forward_request.php",
    data:{'req':requ,'path':path,'channelid':channelid,'fmsg':fmsg,'cid':cid,'gid':gid},
    success:function(data){
		alert(data);
	 // $("#m_contacts,.userid").prop('disabled', true);
	 // alert(userid);
...
$('#m_groups').on("click",".fmsg",function(){
var groupid=$(this).attr('data-muid');
var fmsg="<?php echo $fmsg; ?>";
var cid="<?php echo $cid; ?>";
var gid="<?php echo $gid; ?>";
var requ = "groupForward";
var path = "<?php echo $check_path; ?>";
$.ajax({
    type:'POST',
    url:"<?php echo $check_path; ?>includes/m_forward_request.php",
    data:{'req':requ,'path':path,'groupid':groupid,'fmsg':fmsg,'cid':cid,'gid':gid},
    success:function(data){
		alert(data);
	 // $("#m_contacts,.userid").prop('disabled', true);
	 // alert(userid);
...
$('#m_channels').on("click",".fmsg",function(){
var channelid=	$(this).attr('data-muid');
var fmsg="<?php echo $fmsg; ?>";
var cid="<?php echo $cid; ?>";
var gid="<?php echo $gid; ?>";
