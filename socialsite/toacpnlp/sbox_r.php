...
<head>
    <title><? echo lang('dashboard'); ?> | Socilsite</title>
    <admin charset="UTF-8">
    <admin name="description" content="Socilsite is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
